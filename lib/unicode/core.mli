...
(** Module [Core]: code for creating and using regular expressions, independently
...
module Make
  ...
  T
    with type t = Ast.Make(Cset)(Color_map).t
     and type re = Compile.Make(Cset)(Color_map).re
     and type letter = Cset.letter
