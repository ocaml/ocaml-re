...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9c2ccf6b85fa173f66f735c16dc9f634) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_unicode",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_unicode", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Unicode_groups"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_unicode.ml"});
               Test
                 ({
                     cs_name = "test_unicode";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "bg\000_\145\\ª\140\001Ñ\0239û÷ª\t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
