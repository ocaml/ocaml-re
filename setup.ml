...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1144d4ff151620f5dbdaa12075aff0a5) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("re_test_glob",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$re_test_glob", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("re_test_str",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$re_test_str", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("re_match",
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Enable building benchmarks";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_glob.ml"});
               Executable
                 ({
                     cs_name = "re_test_str";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "o\168p\\\233\238jG\182`\22679\202Z\162";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
